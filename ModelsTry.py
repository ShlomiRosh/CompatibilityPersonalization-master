...
class Model:
    def __init__(self, clf, old_model=None, diss_weight=None, subset_weights=None, hist_range=None, params=None):
...
def evaluate_params(model_type, train_x, train_y, valid_x, valid_y, metric, candidate_params=None, subset_weights=None,
                    old_model=None, hist_range=None, weights_num=5, get_autc=True, verbose=False):
    scores, evaluated_params = [], []
    c_p = candidate_params.copy() if candidate_params is not None else None
    evaluate_params_step(model_type, train_x, train_y, valid_x, valid_y, metric, c_p,
